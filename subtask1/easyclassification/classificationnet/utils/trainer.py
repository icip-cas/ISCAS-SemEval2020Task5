#!/usr/bin/env python
# -*- coding:utf-8 -*-
# Modified from AllenNLP's Trainer
# add ``automatic_mixed_precision``
...
class Trainer(TrainerBase):
    def __init__(self,
                 ...
                 automatic_mixed_precision: str = None) -> None:
        """
        ...
        automatic_mixed_precision: ``Automatic Mixed Precision``, optional, (default = False)
            If true, we will use automatic mixed precision provided by amp from NVIDIA.
        ...
        self._automatic_mixed_precision = automatic_mixed_precision
        if self._automatic_mixed_precision:
            try:
                from apex import amp
            except ImportError:
                raise ImportError("Please install apex from https://www.github.com/nvidia/apex to use fp16 training.")
            logger.info("Training using Mixed Precision")
            self.model, self.optimizer, = amp.initialize(self.model,
                                                         self.optimizer,
                                                         opt_level=self._automatic_mixed_precision)
