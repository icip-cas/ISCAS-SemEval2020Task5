...
def main():
    ...
    for pred_file in args.pred_file:
        ...
        for gold, pred, sentence in zip(gold_list, pred_list, true_sentences):
            assert gold[0] == pred[0] == sentence[0]
            if gold[1] != pred[1] or gold[2] != pred[2]:
                print('==========================')
                print(gold, pred)
                print("sent\t", sentence[1])
                print('--------------------------')
                print("gold\t", sentence[1][int(gold[1]):int(gold[2])+1])
                print("pred\t", sentence[1][int(pred[1]):int(pred[2])+1])
                print('--------------------------')
                print("gold\t", sentence[1][int(gold[3]):int(gold[4])+1])
                print("pred\t", sentence[1][int(pred[3]):int(pred[4])+1])
                print('==========================')
                print('\n')
                input()
